...
describe('Welcome page', async () => {
  ...
  test('For not authentificated', async () => {
    ...
    expect(screen.getByText('Lets auth! And feel free to use our REST and GraphQL client')).toBeInTheDocument();
  ...
  test('graphiql', async () => {
    ...
    const loginBtn = screen.getByRole('button', { name: 'GraphQL' });
